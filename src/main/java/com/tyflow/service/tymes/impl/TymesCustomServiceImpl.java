package com.tyflow.service.tymes.impl;
...
@Service("TymesCustomService")
@Transactional
public class TymesCustomServiceImpl implements TymesCustomService {

	private static final Logger logger = LoggerFactory.getLogger(TymesCustomServiceImpl.class);
	...
	public void taskAssign(TaskEntity taskEntity) {
		...
		String assignString=(String) runtimeSerivce.getVariable(taskEntity.getExecutionId(), "sysAssignee");
